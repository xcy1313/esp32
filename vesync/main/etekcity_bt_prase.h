...
//帧头帧尾定义
#define BT_FRAME_HEAD          0xA5    //帧起始符
#define BT_FRAME_END           0x5A    //帧结束符
 ...
 */
unsigned short bt_data_frame_encode(unsigned char ctrl,unsigned char cnt,unsigned short cmd,unsigned char *data,unsigned short datalen,unsigned char *outbuf);
